...
import {DatastoreShortString} from "./DatastoreShortString.sol";
/**
...
contract DatastoreSetWrapper {
    ...
    DatastoreShortString public immutable DATASTORE_SET_SHORT_STRING;
    ...
    constructor() {
        ...
        DATASTORE_SET_SHORT_STRING = new DatastoreShortString();
    }
}
